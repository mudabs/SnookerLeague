...
<head>
    ...
    <title>Nevsun Premier Pool League Management Application</title>
    <!-- Link css -->
...
<body>
    ...
    <script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v19.0&appId=974562837372460"
        nonce="xWufZURu"></script>
    ...
    <div class="bodyFlex">
        <div class="sideBody">
                            ...
                            <div class="table">
                                <table>
                                    ...
                                    <tr class="tr" style="padding: 1rem 0">
                                        ...
                                        <td class="flex">
                                            <div class="teamLogoDiv">
                                                <img src="assets/logos/team%20%281%29.png" alt="Team Logo"
                                                    class="teamLogo">
                                            </div>
                                            <div class="name">Team 1</div>
                                        </td>
                                    ...
                                    <tr class="tr">
                                        ...
                                        <td class="flex">
                                            <div class="teamLogoDiv">
                                                <img src="assets/logos/team%20%282%29.png" alt="Team Logo"
                                                    class="teamLogo">
                                            </div>
                                            <div class="name">Team 2</div>
                                        </td>
                                    ...
                                    <tr class="tr">
                                        ...
                                        <td class="flex">
                                            <div class="teamLogoDiv">
                                                <img src="assets/logos/team%20%283%29.png" alt="Team Logo"
                                                    class="teamLogo">
                                            </div>
                                            <div class="name">Team 3</div>
                                        </td>
                                    ...
                                    <tr class="tr">
                                        ...
                                        <td class="flex">
                                            <div class="teamLogoDiv">
                                                <img src="assets/logos/team%20%284%29.png" alt="Team Logo"
                                                    class="teamLogo">
                                            </div>
                                            <div class="name">Team 4</div>
                                        </td>
            ...
            <section class="section container twitterSection">
                ...
                <!-- <div class="fb-page" data-href="https://www.facebook.com/profile.php?id=100054418333702"
                    data-tabs="timeline" data-width="" data-height="" data-small-header="false"
                    data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                    <blockquote cite="https://www.facebook.com/profile.php?id=100054418333702"
                        class="fb-xfbml-parse-ignore"><a
                            href="https://www.facebook.com/profile.php?id=100054418333702">Premier Pool League</a>
                    </blockquote>
                </div> -->

                <iframe style="width: 470px;"
                    src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D100054418333702&tabs=timeline&width=1100&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=false&appId=974562837372460"
        ...
        <div class="mainBody">
            ...
            <div class="bannerSection"
                style="background:url(./static/images/pooltable2.webp);background-repeat: no-repeat;">
            ...
            <section class="section container aboutSection">
                <div class="sectionContainer grid">
                    <div class="textDiv">
                        ...
                        <p>
                            The Nevsun Premier Pool League is committed to maintaining a doping-free environment for all
                            our
                            players. We believe in fair play and achieving success through hard work and dedication.
                            <br> <br>
                            ...
                            <div class="table">
                                <table>
                                    ...
                                    <tr class="tr">
                                        ...
                                        <td class="flex">
                                            <div class="teamLogoDiv">
                                                <img src="assets/logos/team%20%285%29.png" alt="Team Logo"
                                                    class="teamLogo">
                                            </div>
                                            <div class="name">Team 5</div>
                                        </td>
                ...
                <div class="sponsorsContainer swiper">
                    <div class="swiper-wrapper">
                        <div class="sponsor swiper-slide">
                            <img src="assets/logos/logo%20%281%29.png" alt="sponsor logo" class="swiperImg"
                                style="width: 150px; margin: auto">
                        </div>
                        <div class="sponsor swiper-slide">
                            <img src="assets/logos/logo%20%282%29.png" alt="sponsor logo" class="swiperImg"
                                style="width: 150px; margin: 1rem auto 0">
                        </div>
                        <div class="sponsor swiper-slide">
                            <img src="assets/logos/logo%20%283%29.png" alt="sponsor logo" class="swiperImg"
          ...
          <div class="formContainer">
            ...
            <!-- <section class="section container twitterSection sectionDesign">
                ...
                <!-- <iframe style="width: 1000px;"
                    src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D100054418333702&tabs=timeline&width=1100&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=false&appId=974562837372460"
                    width="1100" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0"
                    allowfullscreen="true"
                    allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" ></iframe> -->
            <!-- </section>  -->
            <!-- Social Platform Section ends ========================== -->
