            ...
            <div class="clubsContainer container">
                          ...
                          <div class="singleClubTop flex">
                            <div class="leftRow flex">
                              ...
                              <div class="clubName">
                                <span class="name">River Plate</span>
                                <span class="classYear">Established: 2023</span>
                              </div>
                            </div>
                            <div class="rightRow">
                              <!--<a href="https://slma.isratechyt.com/singleclub?id=25"-->
    ...
    <div class="mainBody">
        <div class="aboutBanner">
            ...
            <span class="bannerText">
                <i class="uil uil-browser icon"></i>
                <p>The Crane</p>
                    <h2>Fixtures</h2>
            </span>
            </div>
                        ...
                        <div class="allFixtures">
                                ...
                                <div class="teams flex">
                                  ...
                                  <div class="teamName_teamLogo flex">
                                    ...
                                    <div class="name">FC Nates</div>
                                  </div>
                                </div>
                                <span class="venue"><strong>Venue: </strong>Kyamate Stadium</span>   
                            </div>
                                                      <div class="singleFixture">
                                <div class="teams flex">
                                  <div class="teamName_teamLogo flex">
                                    <div class="name">Flamengo </div>
                                    <div class="teamLogoDiv">
                                  ...
                                  <div class="teamName_teamLogo flex">
                                    ...
                                    <div class="name">Persepolis FC</div>
                                  </div>
                                </div>
                                <span class="venue"><strong>Venue: </strong>Maracanã  Stadium</span>   
                            </div>
                                                      <div class="singleFixture">
                                <div class="teams flex">
                                  <div class="teamName_teamLogo flex">
